...
public class PasswordInputActivity extends XszBaseActivity {
...
//        passwordInputView.getPasswordString();
...
//                Toast.makeText(PasswordInputActivity.this, "两次密码输入不同" + oldPsd + "!=" + newPsd, Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(PasswordInputActivity.this, "密码相同" + psd, Toast.LENGTH_SHORT).show();
...
//                passwordInputView.cleanPsd();
            ...
            public void inputFinished(String inputPsd) {
                // TODO: 2018/1/3 输完逻辑
//                Toast.makeText(PasswordInputActivity.this, "输入完毕：" + inputPsd, Toast.LENGTH_SHORT).show();
