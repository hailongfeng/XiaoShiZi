...
import edu.children.xiaoshizi.adapter.view.StudentView;
 ...
 * @author Lemon
 */
public class StudentAdapter extends BaseAdapter<Student, StudentView> {
	...
	@Override
	public StudentView createView(int position, ViewGroup parent) {
		return new StudentView(context, parent);
	}
