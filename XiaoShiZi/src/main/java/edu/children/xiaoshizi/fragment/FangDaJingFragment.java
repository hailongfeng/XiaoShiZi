 ...
 */
public class FangDaJingFragment extends BaseFragment implements OnClickListener, OnDialogButtonClickListener {
//	private static final String TAG = "WoDeFragment";
	 ...
	 * @return
	 */
	public static FangDaJingFragment createInstance() {
		return new FangDaJingFragment();
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		setContentView(R.layout.fangdajing_fragment);
		//类相关初始化，必须使用>>>>>>>>>>>>>>>>
