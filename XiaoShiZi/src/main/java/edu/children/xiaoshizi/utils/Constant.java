...
//    public static final String BASEURL = "http://api.huangweicai.com/mock/53/apprest/v1/";
//    public static final String BASEURL = "https://app.pinocc.cn/apprest/";//测试
    public static final String BASEURL = "http://app.shine-creativity.com/apprest/";//正式
    ...
    public static final String CACHE_DIR_FILE = "imageFile";
    public static final String SP_NAME= "xsz";


    public static final String cache_user= "userLogin";
}
